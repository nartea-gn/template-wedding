...
(
    ...
    CONSTRAINT "invitation_admins_invitation_id_check" CHECK
(
    (
    (
    "char_length"(
...
(
    ...
    "locale" "text",
    "answers" "jsonb",
    CONSTRAINT "rsvp_responses_answers_check" CHECK
(
    (
(
    "answers"
...
(
    ...
    CONSTRAINT "rsvp_responses_bus_option_check" CHECK
(
    (
(
    "bus_option"
...
(
    ...
    CONSTRAINT "rsvp_responses_dietary_options_check" CHECK
(
    (
    (
    "cardinality"
...
(
    ...
    CONSTRAINT "rsvp_responses_dietary_other_check" CHECK
(
    (
(
    "dietary_other"
...
(
    ...
    CONSTRAINT "rsvp_responses_form_id_check" CHECK
(
    (
(
    "form_id"
...
(
    ...
    CONSTRAINT "rsvp_responses_form_version_check" CHECK
(
    (
(
    "form_version"
...
(
    ...
    CONSTRAINT "rsvp_responses_full_name_check" CHECK
(
    (
    (
    "char_length"(
...
(
    ...
    CONSTRAINT "rsvp_responses_locale_check" CHECK
(
    (
(
    "locale"
...
(
    ...
    CONSTRAINT "rsvp_responses_message_check" CHECK
(
    (
(
    "message"
...
(
    ...
    CONSTRAINT "rsvp_responses_song_request_check" CHECK
(
    (
(
    "song_request"
...
(
    ...
    CONSTRAINT "rsvp_responses_wedding_slug_check" CHECK
(
    (
    (
    "char_length"(
...
ALTER TABLE ONLY "public"."invitation_admins"
    ADD CONSTRAINT "invitation_admins_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON
DELETE
CASCADE;
...
CREATE
POLICY "invitation_admins_select_own" ON "public"."invitation_admins" FOR
SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
UPDATE ON SEQUENCES TO "anon";
ALTER
DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "public" GRANT
UPDATE ON SEQUENCES TO "authenticated";
ALTER
DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "public" GRANT
...
ALTER
DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "public" GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLES TO "anon";
ALTER
DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "public" GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLES TO "authenticated";
ALTER
DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "public" GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLES TO "service_role";
