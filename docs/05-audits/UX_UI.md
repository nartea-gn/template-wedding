...
La invitación tiene una dirección visual coherente y cinco temas, pero la narrativa está fijada: hero, contador, ornamento, vídeo, localización y CTA. No puede adaptarse al contenido real de una pareja sin editar JSX.
...
- Existen estilos globales útiles (`btn`, `card`, `input`), aunque hover y movimiento no documentan reducción de movimiento.
...
Revisar en 360, 390, 768 y 1440 px; teclado completo; contraste AA; zoom 200%; estados vacíos/error y una invitación sin RSVP.
