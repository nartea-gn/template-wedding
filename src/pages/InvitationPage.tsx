...
export default function InvitationPage() {
    ...
    return (
        <div
            className="min-h-screen bg-wedding-bg text-wedding-dark flex flex-col items-center justify-between p-6 md:p-12 font-sans selection:bg-wedding-primary/20">
